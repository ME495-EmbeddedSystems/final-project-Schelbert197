...
class Drawing(Node):
    ...
    def __init__(self):
        ...
        self.moveit_mp_service = self.create_service(
            Pose, '/moveit_mp', self.moveit_mp_callback, 10, callback_group=self.moveit_mp_callback_group)
        ...
        self.cartesian_mp_service = self.create_service(
            Cartesian, '/cartesian_mp', self.cartesian_mp_callback, 10, callback_group=self.cartesian_mp_callback_group)
        ...
        self.plan_joint_state_service = self.create_service(
            JointState, '/jointstate_mp', self.jointstate_mp_callback, 10, callback_group=self.jointstate_mp_callback_group)
