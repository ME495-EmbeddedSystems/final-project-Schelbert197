...
exec(open("/home/graham/classes/Q1/ME495/final_project/docs_build/drawing/drawing/default_sphinx_project/conf.py").read())
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['brain_interfaces', 'franka_msgs']:
        try:
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "drawing Doxygen Project": "generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/graham/classes/Q1/ME495/final_project/docs_build/drawing/drawing/default_sphinx_project/generated",
